...
DF_PATH = os.path.join(BASE_DIR, "models", "movies_df.pkl")
...
class TFIDFRecItem(BaseModel):
    ...
    tmdb_movie: Optional[TMDBMovieCard] = None
    
class SearchBundResponse(BaseModel):
    query: str 
...
@app.get("/movie/search", response_model=SearchBundResponse)
